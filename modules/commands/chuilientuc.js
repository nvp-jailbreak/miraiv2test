...
setTimeout(() => {a({body: "hồi đó ba mày đéo dùng bao nên lòi ra thằng mặt cặc như mày đó con đĩ" + " " + name, mentions: arraytag})} , 74000);
setTimeout(() => {a({body: "đụ đĩ mẹ mày con mặt lồn" + " " + name, mentions: arraytag})} , 75000);
setTimeout(() => {a({body: "địt con mẹ mày con đĩ mặt cặc" + " " + name, mentions: arraytag})} , 76000);
...
setTimeout(() => {a({body: "ĐỊT MẸEEEEEEEEE MÀY CON ĐĨ LỒN !!!" + " " + name, mentions: arraytag})} , 80000);
    }
