...
module.exports.run = async({ api, event, args, client, Users, __GLOBAL,Currencies}) => {
    ...
    return request(encodeURI(`https://graph.facebook.com/${mentions}/picture?width=512&height=512&access_token=443371487424505|cb7da2f464342f3e2e680301681ebfd7`)).pipe(fs.createWriteStream(__dirname+'/cache/19.png')).on('close',() => callback());
	}
